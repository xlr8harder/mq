...
When completing a session of work:
...
2. Commit
 - If you changed any synthesis logic, regenerate a small sample and critically review the outputs before committing.
 - Tests must always pass before commits.
 - Git commit any changes to artifacts, etc.
3. Choose next work
